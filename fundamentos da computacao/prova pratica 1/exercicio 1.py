...
n=int(raw_input('informe o numero de participantes:'))

#parte da repetição
for i in range(n):
    a=int(raw_input('Informe a sua idade:'))
    b=str(raw_input('Informe seu sexo (M ou F):'))
    c=int(raw_input('Informe seu salário:'))
