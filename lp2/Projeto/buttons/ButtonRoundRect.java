...
public class ButtonRoundRect extends Button{

	public ButtonRoundRect(int idx, Figure fig) {
		super(idx, fig);
	}
	...
	public void paint(Graphics g, boolean focused) {
        ...
        g2d.setColor(super.getFig().getFill());
        g2d.fillRoundRect(super.getFig().getX(), super.getFig().getY(), super.getFig().getW(), super.getFig().getH(),10,10);
	}
}
