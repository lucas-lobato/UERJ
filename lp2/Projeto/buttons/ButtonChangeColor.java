...
public class ButtonChangeColor extends Button{

	public ButtonChangeColor(int idx, Figure fig) {
		super(idx, fig);
	}
	...
	public void paint(Graphics g, boolean focused) {
        ...
        g2d.setFont(font);
        g2d.drawString("Change Color", super.getFig().getX() - 3, super.getFig().getY() + 14);
	}
